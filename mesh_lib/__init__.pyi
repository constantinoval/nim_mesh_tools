...
class Mesh:
    ...
    def pairs_for_periodic_bc(self) -> Tuple:
        """
            ...
            Returns
            _______
            Tuple - (fixed: int, dx, dy, dz: float, pairs: Dict[string, list[list[list[2, int]]]])
            ...
            pairs - список пар индексов узлов для периодических граничных условий:
                pairs["plainx"] - пары узлов на плоскостях, параллельных координатной плоскости 0X

                pairs["plainy"] - пары узлов на плоскостях, параллельных координатной плоскости 0Y

                pairs["plainz"] - пары узлов на плоскостях, параллельных координатной плоскости 0Z

                pairs["linesx"] - пары узлов на ребрах, параллельных координатной оси 0X

                pairs["linesy"] - пары узлов на ребрах, параллельных координатной оси 0Y

                pairs["linesz"] - пары узлов на ребрах, параллельных координатной оси 0Z
